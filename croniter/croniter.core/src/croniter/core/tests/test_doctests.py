...
from croniter.core.tests.base import FunctionalTestCase
...
from croniter.core.testing import CRONITER_CORE_FUNCTIONAL_TESTING as FUNCTIONAL_TESTING
...
def test_suite():
    """."""
    logger = logging.getLogger('croniter.core')
    ...
    try:
        ...
        logger.warn('No doctests for croniter.core')
