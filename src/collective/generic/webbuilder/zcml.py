...
class ITemplate(Interface):
    name = schema.BytesLine(
        ...
        required=True)
    order = schema.Int(
        title=u"template generation order",
        description=u"The template generation order",
        required=True)
    output = schema.Int(
        title=u"template generation folder",
...
class IOption(Interface):
    name = schema.BytesLine(
        ...
        required=True)
    type = schema.BytesLine(
        title=u"Options type",
        description=u"This is options type",
        required=False)
    default = schema.BytesLine(
        title=u"Options default",
...
class IExcludeOptionDirective(Interface):
    name = schema.BytesLine(
        title=u"exclude option",
        description=u"this is an option to exclude",
        required=True)
